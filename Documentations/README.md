...
| 文档 | 说明 |
|---|---|
| [objc-section 使用指南](Guides/ObjCSectionCommandLine.md) | 0002 的配套。命令行用法，以及四条从签名和帮助文本里看不出来的契约：文件模式超类链截断、RW data 不在泛型接口上、分析 cache 需要 MachOKit 0.52.101+、纯 Swift 类的 ivar 记录对不上 |
